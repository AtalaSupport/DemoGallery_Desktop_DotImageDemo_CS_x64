...
This is the C# version. A [VN.NET version](https://github.com/AtalaSupport/DemoGallery_Desktop_DotImageDemo_VB_x64.git) is also available.
...
## Downloading source
The sources can be downloaded for [c#](https://github.com/AtalaSupport/DemoGallery_Desktop_DotImageDemo_CS_x64/archive/refs/heads/main.zip) and [VB.NET](https://github.com/AtalaSupport/DemoGallery_Desktop_DotImageDemo_VB_x64/archive/refs/heads/main.zip)
...
```bash
git clone https://github.com/AtalaSupport/DemoGallery_Desktop_DotImageDemo_CS__x64.git DotImageDemo --recursive
cd DotImageDemo
git submodule init
